    ...
    <section ref={ref} className="relative py-32 px-6">
      <div className="max-w-4xl mx-auto text-center">
        <div className="reveal mb-16">
          <p className="font-accent text-sm tracking-[0.4em] text-primary-glow/80 uppercase mb-6">Para quem é</p>
        ...
        <div className="space-y-6">
          {profiles.map((p, i) => (
            ...
            >
              <span className="font-accent text-4xl md:text-5xl text-primary-glow/50 group-hover:text-primary-glow transition-colors tracking-wider">
                0{i + 1}
              </span>
