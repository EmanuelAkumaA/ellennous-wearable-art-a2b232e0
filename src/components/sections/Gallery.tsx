    ...
    <section id="galeria" ref={ref} className="relative py-32 px-6 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="reveal text-center mb-16">
          <p className="text-xs tracking-[0.4em] text-primary-glow/80 uppercase mb-6">Galeria</p>
        ...
        <div className="reveal flex flex-wrap justify-center gap-2 md:gap-3 mb-12">
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={`px-4 md:px-5 py-2 text-xs md:text-sm tracking-wider uppercase border transition-all duration-500 ${
                filter === cat
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((piece, i) => (
            ...
            >
              ...
              {piece.destaque && (
                <span className="absolute top-4 right-4 text-[10px] tracking-[0.3em] uppercase bg-brand-red/90 text-white px-3 py-1">
                  Destaque
                </span>
              )}
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <p className="text-[10px] tracking-[0.3em] uppercase text-primary-glow mb-2">{piece.categoria}</p>
          ...
          {selected && (
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="p-8 flex flex-col">
                <p className="text-[10px] tracking-[0.3em] uppercase text-primary-glow mb-3">{selected.categoria}</p>
                ...
                <Button
                  asChild
                  className="mt-8 bg-gradient-purple-wine border border-primary-glow/40 hover:shadow-glow text-white rounded-none h-12"
                >
                  <a
