      ...
      <div className="relative max-w-4xl mx-auto text-center">
        <div className="reveal">
          ...
          <Button
            asChild
            size="lg"
            className="font-accent text-base sm:text-lg bg-foreground text-background hover:bg-primary-glow hover:text-primary-foreground tracking-[0.2em] uppercase px-6 sm:px-10 h-14 sm:h-16 rounded-none shadow-elegant whitespace-normal text-center"
          >
